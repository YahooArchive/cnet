...
# found in the LICENSE file.
{
  'variables': {
    ...
    'cnet_android_sources': [
      ...
      'cnet/android/com_yahoo_cnet_Cnet.cc',
      'cnet/android/com_yahoo_cnet_Cnet.h',
      'cnet/android/com_yahoo_cnet_Fetcher.cc',
      'cnet/android/com_yahoo_cnet_Fetcher.h',
      'cnet/android/com_yahoo_cnet_Pool.cc',
      'cnet/android/com_yahoo_cnet_Pool.h',
      'cnet/android/com_yahoo_cnet_Response.cc',
      'cnet/android/com_yahoo_cnet_Response.h',
      'cnet/android/com_yahoo_cnet_ResponseCompletion.cc',
      'cnet/android/com_yahoo_cnet_ResponseCompletion.h',
    ],
  },
  'targets': [
    {
          ...
          'actions': [
             ...
             },
             {
               ...
               'action': [
                 ...
                 '--src-path=<(PRODUCT_DIR)/gen/templates',
